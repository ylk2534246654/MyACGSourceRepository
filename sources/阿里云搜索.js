function manifest() {
	return JSON.stringify({
		...
		//搜索源自动同步更新网址
		syncList: {
			"Gitee":  "https://gitee.com/ylk2534246654/MyACGSourceRepository/raw/master/sources/阿里云搜索.js",
		...
		//@NonNull 详情页的基本网址
		baseUrl: "https://www.maoliyun.com",
	});
}
const header = '';
 ...
 */
function search(key) {
	var url = `https://www.maoliyun.com/search?k=${encodeURI(key)}` + header;
