function manifest() {
	return JSON.stringify({
		...
		syncList: {
			...
			"GitLink": "https://www.gitlink.org.cn/api/ylk2534246654/MyACGSourceRepository/raw/sources%2FcocoManga.js?ref=master",
		...
		httpRequestHeaderList: {
			"user-agent": `Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/123.0.0.0 Mobile Safari/537.36 Edg/123.0.0.0 TimeStamp/${JavaUtils.getPreference().getLong("headerTimeStamp")}`,
			"Referer": baseUrl
		},
	})
}
