function manifest() {
	return JSON.stringify({
		...
		syncList: {
			...
			"KKGithub": "https://kkgithub.com/ylk2534246654/MyACGSourceRepository/raw/master/sources/Nike影视.js",
...
function detail(url) {
	...
	if(response.code() == 200){
		...
		return JSON.stringify({
			...
			//最近更新时间
			//lastUpdateTime: document.selectFirst('.module-info-content > div > div:nth-child(8) > div').text(),
