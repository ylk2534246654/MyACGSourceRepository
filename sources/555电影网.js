function manifest() {
	return JSON.stringify({
		...
		//搜索源自动同步更新网址
		syncList: {
			"Gitee":  "https://gitee.com/ylk2534246654/MyACGSourceRepository/raw/master/sources/555电影网.js",
		...
		//@NonNull 详情页的基本网址
		baseUrl: "https://www.555dd1.com",//导航网址：https://www.555app.cc/、导航网址2：https://www.555kan.net/
		
		//登录授权是否启用
		auth: true,
		
		//登录授权网址
		authUrl:"https://www.555dd1.com/vodsearch/-------------.html?wd=" + header,
		...
		//发现
		findList: {
			"最近更新": "https://www.555dd1.com/label/new.html",
		},
	});
}
/*
 ...
 */
function authVerify() {
	const response = httpRequest("https://www.555dd1.com/vodsearch/-------------.html?wd=" + header);
 ...
 */
function search(key) {
	var url = 'https://www.555dd1.com/vodsearch/-------------.html?wd='+ encodeURI(key) + header;
