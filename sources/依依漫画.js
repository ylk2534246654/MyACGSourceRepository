function manifest() {
	return JSON.stringify({
		...
		//搜索源自动同步更新链接
		syncList: {
			"Gitee":  "https://gitee.com/ylk2534246654/MyACGSourceRepository/raw/master/sources/依依漫画.js",
			...
			"Coding": "https://ylk2534246654.coding.net/p/myacg/d/MyACGSourceRepository/git/raw/master/sources/依依漫画.js",
		...
		//@NonNull 详细界面的基本网址
		baseUrl: "https://m.yiyimanhua.com",
		
		//发现
		findList: {
			"完结": "https://m.yiyimanhua.com/list/wanjie/",
			"都市": "https://m.yiyimanhua.com/list/dushi/",
			"后宫": "https://m.yiyimanhua.com/list/hougong/",
			"穿越": "https://m.yiyimanhua.com/list/chuanyue/"
		},
	});
}
 ...
 */
function search(key) {
	var url = 'https://m.yiyimanhua.com/search/?keywords=' + encodeURI(key) + header;
