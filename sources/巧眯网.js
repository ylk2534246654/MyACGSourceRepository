function manifest() {
	return JSON.stringify({
		...
		//搜索源自动同步更新网址
		syncList: {
			"Gitee":  "https://gitee.com/ylk2534246654/MyACGSourceRepository/raw/master/sources/巧眯网.js",
			"极狐":   "https://jihulab.com/ylk2534246654/MyACGSourceRepository/-/raw/master/sources/巧眯网.js",
		...
		//@NonNull 详情页的基本网址
		baseUrl: "http://m.qiaomi.cn",//备份：http://xiaobeizi.2kongjiang.com/
	});
}
const header = '';
 ...
 */
function search(key) {
	var url = `http://m.qiaomi.cn/s/${encodeURI(key)}` + header;
	...
	for (var i=0;i<list.length;i++) {
		...
		array.push({
			...
			//概览
			summary : jsoup(data,'.resname:nth-child(3)').text(),
